#ifndef __CLOUD_SEARCH_CONFIG_ENGINE_H__
#define __CLOUD_SEARCH_CONFIG_ENGINE_H__
...
class ConfigUri
{
    public:
        ...
        std::map<std::string, std::string > Make(const std::map<std::string, std::string>& req_params) const;
...
class ConfigEngine : public ConfigOption
{
    public:
        ...
        bool Init(const std::string& name, boost::shared_ptr<cloud_search::Config> config);
        bool IsValid() const;
    ...
    protected:
        ...
        std::string name_;
        ConfigUri   uri_;
        boost::shared_ptr<cloud_search::Config> config_;
};
...
class ConfigEngines
{
    public:
        ...
        bool Init(boost::shared_ptr<cloud_search::Config> config);
